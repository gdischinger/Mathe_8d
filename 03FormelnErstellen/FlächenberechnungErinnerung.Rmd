...
$(6a+8b)² =$ `r mcq(c("36a²+64b²", "6a²+48ab+8b²", answer = "36a²+96ab+64b²",  "6a²+96ab+8b²", "nichts davon ist richtig"))`

$(4s-3t)² =$ `r mcq(c("4s²-12st+3t²", answer = "16s²-24st+9t²", "16s²-9t²",  "4s²-3t²", "nichts davon ist richtig"))`
...
<!-- ### [Höhentraining](https://gdischinger.github.io/Mathe_8d/03FormelnErstellen/Höhentraining.html) -->
