...
Für den Durchmesser $d$ des Kreises gilt: $\quad d=2\cdot r$

Für den Umfang $U$ des Kreises gilt:

$$\begin{align} U&= d \cdot \pi \\
{}\\
U &= 2 \cdot r \cdot \pi
\end{align}$$
<!-- Ein Kreis mit dem Radius $r$ und dem Durchmesser $d$ hat den Umfang $\quad U= d \cdot \pi\quad$ oder $\quad U = 2 \cdot \pi \cdot r$, $\quad$ da für den Durchmesser $d$ gilt $\quad d=2\cdot r$. -->

Für den Flächeninhalt gilt: $\quad A=\pi \cdot r²$
