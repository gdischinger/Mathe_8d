...
Damit hat das Dreieck den Flächeninhalt:
$$ A = {1 \over 2} \cdot g \cdot h = {1 \over 2} \cdot 4 cm \cdot 6 cm = 12 cm² $$
Gesucht ist nun die Länge der Höhe eines flächengleichen Trapezes mit den parallelen Seiten $a = 2cm$ und $c = 4cm$.
...
Diese Gleichung muss man nun nach $(a+c)$ auflösen:
